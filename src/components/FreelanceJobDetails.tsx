...
interface JobDetailsProps {
  job: Job;
  onApplicationSuccess?: () => void; // ADDED - Optional callback to refresh job data
}

const FreelanceJobDetails: React.FC<JobDetailsProps> = ({
  job,
  ...
  const handleApplyClick = () => {
    openApplicationModal(job._id, job.title);
  };
