      ...
      <div className='w-full max-w-6xl mx-auto bg-gray-900 rounded-lg shadow-2xl p-4 sm:p-6 lg:p-8 border border-gray-700'>
        ...
        <div className='flex flex-col lg:flex-row lg:justify-between lg:items-start gap-4 mb-6'>
          ...
          <div className='flex flex-wrap gap-2 lg:flex-nowrap lg:gap-3'>
            ...
            {/* Edit */}
            <button className='px-3 py-1 sm:px-4 sm:py-1 rounded-full text-xs sm:text-sm font-semibold border bg-green-700/100 cursor-pointer hover:bg-green-600 transition-colors whitespace-nowrap flex items-center gap-1'>
              <span>
                <MdEdit />
              </span>
              Edit
